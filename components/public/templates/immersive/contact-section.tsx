...
// ==========================================
// Immersive "Dark Knight" Contact Component
// ==========================================
export default function ImmersiveContactSection() {
  ...
  return (
    ...
    >
      ...
      <div
        className="absolute inset-0 flex justify-center items-center pointer-events-none opacity-15 dark:opacity-20"
        aria-hidden="true"
      >
        <svg
          width="800"
          ...
          className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 scale-150 sm:scale-100 stroke-[var(--text-primary)]"
        >
          <path
        ...
        {status === 'success' ? (
          ...
          >
            ...
            <button
              ...
              className="mt-8 px-6 py-2.5 rounded-full text-sm font-medium bg-[var(--bg-surface)] text-[var(--text-secondary)] hover:text-[var(--text-primary)] border border-[var(--border-subtle)] hover:border-[var(--border-strong)] transition-colors shadow-sm focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--accent-color)]"
            >
              {t('newTransmission')}
            </button>
          </motion.div>
          ...
          >
            ...
            <div className="space-y-6">
              ...
              <div>
                <label
                  htmlFor="name"
                  className="block text-xs font-bold tracking-widest text-[var(--text-tertiary)] uppercase mb-2"
                >
                  {t('nameLabel')}
                </label>
                <input
                  ...
                  className={`w-full bg-[var(--bg-surface)] border ${
                    validationErrors.name
                      ...
                      : 'border-[var(--border-subtle)] focus:border-[var(--accent-color)]'
                  } rounded-xl px-4 py-3 text-[var(--text-primary)] placeholder:text-[var(--text-tertiary)] outline-none transition-colors duration-300 shadow-inner focus:ring-1 focus:ring-[var(--accent-color)]`}
                ...
                <textarea
                  ...
                  className={`w-full bg-[var(--bg-surface)] border ${
                    validationErrors.message
                      ? 'border-red-500/50 focus:border-red-500'
                      : 'border-[var(--border-subtle)] focus:border-[var(--accent-color)]'
                  } rounded-xl px-4 py-3 text-[var(--text-primary)] placeholder:text-[var(--text-tertiary)] outline-none transition-colors duration-300 resize-none shadow-inner focus:ring-1 focus:ring-[var(--accent-color)]`}
              ...
              <button
                type="submit"
                disabled={isPending}
                className="group relative w-full overflow-hidden rounded-xl bg-[var(--text-primary)] text-[var(--bg-primary)] font-bold uppercase tracking-widest text-sm py-4 transition-transform active:scale-[0.98] disabled:opacity-70 disabled:active:scale-100 shadow-lg hover:shadow-xl focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--accent-color)]"
              >
